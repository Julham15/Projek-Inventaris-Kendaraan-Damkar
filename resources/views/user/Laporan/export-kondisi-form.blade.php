...
@section('user')
    ...
    <main class="lg:ml-64 p-lg max-w-7xl mx-auto space-y-xl">
        <!-- Header -->
        <section class="mt-md">
            <h1 class="font-h1 text-h1 text-primary mb-xs">Export PDF Kondisi</h1>
            <p class="text-on-surface-variant font-body-regular text-body-regular">Ekspor laporan kondisi kendaraan ke dalam format PDF.</p>
        </section>
        ...
        <section>
            <div class="bg-surface-container-lowest border border-outline-variant rounded-lg overflow-hidden">
                <div class="p-lg">
                    ...
                    <form method="POST"
                          action="{{ route('laporan.export.kondisi', $laporan) }}"
                          class="space-y-md">
                        ...
                        <div class="flex flex-wrap items-center gap-md pt-md">
                            ...
                            <button
                                type="submit"
                                class="inline-flex items-center gap-1 px-md py-2 bg-secondary text-on-error rounded-lg hover:bg-error-hover transition-colors">
