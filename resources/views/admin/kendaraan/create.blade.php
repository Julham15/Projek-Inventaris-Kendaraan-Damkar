...
<header class="flex justify-between items-center w-full px-lg py-md sticky top-0 z-40 bg-white border-b border-outline-variant">
    <div class="flex items-center gap-md">
        ...
        <span class="font-h2 text-h2 font-bold text-primary">Tambah Kendaraan</span>
    </div>
...
<div class="p-lg md:p-margin flex-1 overflow-x-hidden">
    ...
    <div class="flex items-center gap-md mb-lg">
        ...
        <div>
            <h1 class="font-h1 text-h1 text-on-background">Tambah Kendaraan</h1>
            <p class="font-body-regular text-body-regular text-on-surface-variant mt-1">
                Tambahkan kendaraan baru untuk jenis <strong>{{ $jenis_mobil->nama_jenis }}</strong> di <strong>{{ $posko->nama_posko }}</strong>
            </p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-[#D1E9F6] p-lg md:p-xl max-w-3xl">
        <form action="{{ route('posko.jenis-mobil.kendaraan.store', [$posko->id, $jenis_mobil->id]) }}" 
              method="POST" 
    ...
    <div class="mt-xl grid grid-cols-1 md:grid-cols-3 gap-gutter max-w-3xl">
        <div class="bg-[#E6F6FF]/20 p-md rounded-lg flex items-start gap-md border border-[#D1E9F6]">
            ...
            <div>
                <h4 class="font-h4 text-h4 text-on-secondary-fixed">Data Kendaraan</h4>
                <p class="font-small text-small text-on-surface-variant">Pastikan data kendaraan diisi dengan benar dan lengkap.</p>
            </div>
        </div>
        <div class="bg-[#E6F6FF]/20 p-md rounded-lg flex items-start gap-md border border-[#D1E9F6]">
            ...
            <div>
                ...
                <p class="font-small text-small text-on-surface-variant">Upload gambar kendaraan untuk memudahkan identifikasi.</p>
            </div>
        </div>
        <div class="bg-[#E6F6FF]/20 p-md rounded-lg flex items-start gap-md border border-[#D1E9F6]">
